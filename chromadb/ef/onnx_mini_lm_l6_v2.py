...
class ONNXMiniLM_L6_V2(EmbeddingFunction):
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            raise ValueError(
                """The tqdm python package is not installed.
    ...
    def _forward(self, documents: List[str], batch_size: int = 32) -> npt.NDArray:
        # We need to cast to the correct type because the type checker
        # doesn't know that init_model_and_tokenizer will set the values
    ...
    def _init_model_and_tokenizer(self) -> None:
        if self.model is None and self.tokenizer is None:
            ...
            # max_seq_length = 256, for some reason sentence-transformers
            # uses 256 even though the HF config has a max length of 128
